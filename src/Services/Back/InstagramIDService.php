...
class InstagramIDService implements InstagramIDServiceContract
{
     ...
     *
     * @return array The lookup table, where offset 0 has the value of bit 1, offset 1 has the value of bit 2, and so on.
     */
     ...
     *
     * @param string $base2 The binary bits as a string where each character is either "1" or "0".
     *
